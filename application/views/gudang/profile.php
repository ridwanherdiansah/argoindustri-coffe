        ...
        <?= $this->session->flashdata('message');?>
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              ...
              <?= form_open_multipart ('gudang/e_profile/'. $admin_gudang['email']); ?>
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Profile</h6>
                </div>
                <div class="card-body">
                  <input  id="id" name="id" type="hidden" class="form-control" placeholder="" value="<?=$admin_gudang['id'];?>">
                  <div class="form-group row">
                    <div class="col-sm-2">picture</div>
                    <div class="col-sm-10">
                      <div class="row">
                        <div class="col-sm-3">
                          <img src="<?= base_url('assets/admin/img/gudang/').$admin_gudang['image'];?>" class="img-thumbnail">
                        </div>
                        <div class="col-sm-9">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-6 m-0">
                                ...
                                <input id="email" name="email" placeholder="Masukan ID Petani" class="form-control r-0 light s-12" data-time-picker="false" type="text" value="<?= $admin_gudang['email']; ?>" readonly required>
                            </div>

                            <div class="form-group col-6 m-0">
                                <label for="nama" class="col-form-label s-12">Nama</label>
                              <input id="nama" name="nama" placeholder="ID Kopi" class="form-control r-0 light s-12 " type="text" value="<?= $admin_gudang['nama']; ?>" required >
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-12 m-0">
                                ...
                                <textarea id="alamat" name="alamat" class="form-control" placeholder="Masukan alamat " required><?= $admin_gudang['alamat']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-6 m-0">
                                ...
                                <option value=""><?= $admin_gudang['provinsi']; ?></option>
                            ...
                            <div class="form-group col-6 m-0">
                                ...
                                <option value=""><?= $admin_gudang['kota']; ?></option>
                                <?php
                                  if (count($_POST)) {
                                    $curl = curl_init();
