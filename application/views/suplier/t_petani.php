	        ...
	        <div class="animated fadeInUpShort">
	            <div class="row my-3">
	                <div class="col-md-7  offset-md-2">
	                    <?= form_open_multipart ('suplier/p_petani'); ?>
	                            ...
	                            <div class="card-body">
	                                ...
	                                <div class="form-row">
	                                    <div class="col-md-12">
	                                        <div class="form-group m-0">
	                                            ...
	                                            <input id="id_petani" name="id_petani" placeholder="ID Petani" class="form-control r-0 light s-12 " type="text" value="<?= $petani ?>" required readonly >
	                                        </div>
	                                        <div class="form-group m-0">
	                                        ...
	                                        <div class="form-row">
	                                            <div class="form-group col-6 m-0">
	                                                ...
	                                                <input id="tempat_lahir" name="tempat_lahir" placeholder="Masukan tempat lahir petani" class="form-control r-0 light s-12 date-picker" type="text" required>
	                                            </div>
	                                            <div class="form-group col-6 m-0">
	                                                ...
	                                                <input id="tanggal_lahir" name="tanggal_lahir" class="form-control r-0 light s-12 datePicker" data-time-picker="false"
	                                                       data-format-date='Y/m/d' type="date" required>
	                                            </div>
	                                        </div>
	                                ...
	                                <div class="form-row">
	                                    <div class="form-group col-12 m-0">
	                                        ...
	                                        <input type="text" name="alamat" class="form-control r-0 light s-12" id="alamat"
	                                               placeholder="Masukan alamat petani" required>
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-row mt-1">
	                                    <div class="form-group col-4 m-0">
	                                        ...
	                                        <input id="desa" name="desa" placeholder="Masukan nama desa" class="form-control r-0 light s-12 " type="text" required >
	                                    </div>

	                                    <div class="form-group col-4 m-0">
	                                        <label for="kecamatan" class="col-form-label s-12">KECAMATAN</label>
	                                        <input id="kecamatan" name="kecamatan" placeholder="Masukan nama kecamatan" class="form-control r-0 light s-12 " type="text" required >
	                                    </div>
	                                    <div class="form-group col-4 m-0">
	                                        <label for="kota" class="col-form-label s-12">KAB/KOTA</label>
	                                        <input id="kota" name="kota" placeholder="Masukan nama Kab/Kota" class="form-control r-0 light s-12 " type="text" required >
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-row mt-1">
	                                    <div class="form-group col-4 m-0">
	                                        ...
	                                        <input id="email" name="email" placeholder="Masukan alamat email" class="form-control r-0 light s-12 " type="text" required >
	                                    </div>

	                                    <div class="form-group col-4 m-0">
	                                        <label for="telepon" class="col-form-label s-12">TELEPON</label>
	                                        <input id="telepon" name="telepon" placeholder="+62 -" class="form-control r-0 light s-12 " type="text" required >
	                                    </div>
	                                </div>
	                                ...
	                                <div class="col-md-3 offset-md-1">
		                               	<div class="file-field">
								            <div class="z-depth-1-half mb-4">
								              <img src="<?= base_url(); ?>assets/admin/img/suplier/default.jpg" class="img-fluid"
