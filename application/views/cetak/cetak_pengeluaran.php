...
<body onclick="window.print()">
	<center>
    <h2><u>Data Pengeluaran</u></h2>
    Argoindustri Girimekar
    <p align='right'>Tanggal :<?=date('y-m-d')?>
    <br><p align="left"> laporan Data pengeluaran gudang dari tanggal : 
		...
		<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                      ...
                      <?php
                        ...
                        $sub_total = $sub_total + $t['total_pembayaran'];
                      ?>
                          <tr>
                            <td scope="row"><?= $i; ?></td>
